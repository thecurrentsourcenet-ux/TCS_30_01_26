...
export default function HydrogenBookBanner() {
  return (
    <Link to="/hydrogen-book" className="block group">
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.01]">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-0.5 sm:mb-1 leading-tight">
                Hydrogen & Beyond: The 2025 Perspective
              </h3>
              <p className="text-xs sm:text-sm text-blue-100 leading-snug line-clamp-1 sm:line-clamp-none">
                From 2009's breakthrough optimism to today's complex energy reality
              </p>
            </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-300 via-blue-300 to-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
      </div>
    </Link>
  );
}
